...
(function(oauth){
    ...
    var config = require('./authentication-private');
    ...
    oauth.grant  = function(client_id, client_secret, authorization_code, redirect_uri, next) {
        ...
        post_request(options, next);
    };
    
    oauth.refresh  = function(client_id, client_secret, refresh_token, redirect_uri, next) {
        var options = oauth.refresh_request_options(client_id, client_secret, refresh_token, redirect_uri, post_request);
        post_request(options, next);
    };
    ...
    var get_options  = function(client_id, client_secret, body, next) {
    ...
    var post_request = function(options, next){
